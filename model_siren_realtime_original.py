...
model_detection = tf.keras.models.load_model("Detection.h5")

# Load the Siren Recognition Model
model_recognition = tf.keras.models.load_model("Recognition_2.h5")
...
def real_time_detection_recognition():
    ...
    while True:
        ...
        if siren_prob > Detection_Threshold:
            ...
            siren_type = {0: "Ambulance", 1: "Firetruck", 2: "Police", 3: "Traffic"}[predicted_class]
